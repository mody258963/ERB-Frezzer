...
final class DashboardSummaryTransformer
{
    ...
    public static function transform(array $row): array
    {
        return [
            ...
            'weekly_cash_in_realized' => (float) ($row['weekly_cash_in_realized'] ?? 0),
            'weekly_cash_out_realized' => (float) ($row['weekly_cash_out_realized'] ?? 0),
            'weekly_net_cash_flow_realized' => (float) ($row['weekly_net_cash_flow_realized'] ?? 0),
